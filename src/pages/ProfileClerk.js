...
export default function Profile() {
    ...
    const {data:profile} = id ? useFetch('/postMaster/clerk/'+id) : useFetch('/admin/postmaster/'+user._id)
    const navigate = useNavigate()
    const token = localStorage.getItem('adminToken')
    const handleChangeStatus = () => {
        fetch(process.env.REACT_APP_API_HOST+'/postMaster/clerk/updateStatus/'+id,{
            method: 'POST',
            ...
            <Grid  xs={3} item>
                <Card >
                    ...
                    <CardActions style={{float:'right'}}>
                        ...
                        <Button size="small" component={RouterLink} to={id ? '/app/editClerk/'+id :'/app/profile/edit'} color="success">
