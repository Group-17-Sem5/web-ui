...
<<<<<<< HEAD
import eyeFill from '@iconify/icons-eva/checkmark-circle-2-fill';
=======
...
<<<<<<< HEAD
export default function UserMoreMenu({delUrl,conUrl,handleDelete,item,editUrl,viewUrl,handleCancel}) {
=======
...
<<<<<<< HEAD
        {conUrl && <MenuItem sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <Icon icon={eyeFill} width={24} height={24} />
          </ListItemIcon>
          <ListItemText primary="Confirm" primaryTypographyProps={{ variant: 'body2' }} onClick={()=>handleCancel(item)}/>
        </MenuItem>}
